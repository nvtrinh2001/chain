...
async function makeRequest() {
  ...
  const obi = new Obi('{rpc:string,to:string}/{token_supply:string}')
  const calldata = obi.encodeInput({ rpc: 'https://eth.llamarpc.com', to: '0x71C7656EC7ab88b098defB751B7401B5f6d8976F' })
