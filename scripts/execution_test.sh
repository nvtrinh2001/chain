...
bandd tx oracle request 1 1 1 --calldata "0000000000000001" --node http://127.0.0.1:26657 --client-id "my-client" --fee-limit 100000000000uband --offchain-fee-limit 400000000000uband --from requester3 --chain-id bandchain --keyring-backend test --gas 3000000 --keyring-dir ~/.band
