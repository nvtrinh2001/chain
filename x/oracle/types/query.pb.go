...
type QueryCountsResponse struct {
	...
	RequirementFileCount uint64 `protobuf:"varint,2,opt,name=requirement_file_count,json=requirementFileCount,proto3" json:"requirement_file_count,omitempty"`
	// OracleScriptCount is total number of oracle scripts available on the chain
	OracleScriptCount uint64 `protobuf:"varint,3,opt,name=oracle_script_count,json=oracleScriptCount,proto3" json:"oracle_script_count,omitempty"`
...
func (m *QueryCountsResponse) GetRequirementFileCount() uint64 {
	if m != nil {
		return m.RequirementFileCount
	}
	return 0
}
...
// QueryRequirementFileRequest is request type for the Query/RequirementFile RPC
// method.
type QueryRequirementFileRequest struct {
	// RequirementFileID is ID of a requirement file
	RequirementFileId uint64 `protobuf:"varint,1,opt,name=requirement_file_id,json=requirementFileId,proto3" json:"requirement_file_id,omitempty"`
}

func (m *QueryRequirementFileRequest) Reset()         { *m = QueryRequirementFileRequest{} }
func (m *QueryRequirementFileRequest) String() string { return proto.CompactTextString(m) }
func (*QueryRequirementFileRequest) ProtoMessage()    {}
func (*QueryRequirementFileRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_34238c8dfdfcd7ec, []int{6}
}
func (m *QueryRequirementFileRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryRequirementFileRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryRequirementFileRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryRequirementFileRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryRequirementFileRequest.Merge(m, src)
}
func (m *QueryRequirementFileRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryRequirementFileRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryRequirementFileRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryRequirementFileRequest proto.InternalMessageInfo

func (m *QueryRequirementFileRequest) GetRequirementFileId() uint64 {
	if m != nil {
...
// QueryRequirementFileResponse is response type for the Query/RequirementFile
// RPC method.
type QueryRequirementFileResponse struct {
	// RequirementFile is summary information of a data source
	RequirementFile *RequirementFile `protobuf:"bytes,1,opt,name=requirement_file,json=requirementFile,proto3" json:"requirement_file,omitempty"`
}

func (m *QueryRequirementFileResponse) Reset()         { *m = QueryRequirementFileResponse{} }
func (m *QueryRequirementFileResponse) String() string { return proto.CompactTextString(m) }
func (*QueryRequirementFileResponse) ProtoMessage()    {}
func (*QueryRequirementFileResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_34238c8dfdfcd7ec, []int{7}
}
func (m *QueryRequirementFileResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryRequirementFileResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryRequirementFileResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryRequirementFileResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryRequirementFileResponse.Merge(m, src)
}
func (m *QueryRequirementFileResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryRequirementFileResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryRequirementFileResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryRequirementFileResponse proto.InternalMessageInfo

func (m *QueryRequirementFileResponse) GetRequirementFile() *RequirementFile {
	if m != nil {
		return m.RequirementFile
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*QueryRequirementFileRequest)(nil), "oracle.v1.QueryRequirementFileRequest")
	proto.RegisterType((*QueryRequirementFileResponse)(nil), "oracle.v1.QueryRequirementFileResponse")
...
var fileDescriptor_34238c8dfdfcd7ec = []byte{
	...
	,
}
...
type QueryClient interface {
	...
	// RequirementFile queries data source summary info for given data source id.
	RequirementFile(ctx context.Context, in *QueryRequirementFileRequest, opts ...grpc.CallOption) (*QueryRequirementFileResponse, error)
...
func (c *queryClient) RequirementFile(ctx context.Context, in *QueryRequirementFileRequest, opts ...grpc.CallOption) (*QueryRequirementFileResponse, error) {
	out := new(QueryRequirementFileResponse)
	err := c.cc.Invoke(ctx, "/oracle.v1.Query/RequirementFile", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QueryServer interface {
	...
	// RequirementFile queries data source summary info for given data source id.
	RequirementFile(context.Context, *QueryRequirementFileRequest) (*QueryRequirementFileResponse, error)
	// OracleScript queries oracle script summary info for given oracle script id.
...
func (*UnimplementedQueryServer) RequirementFile(ctx context.Context, req *QueryRequirementFileRequest) (*QueryRequirementFileResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RequirementFile not implemented")
}
...
func _Query_RequirementFile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryRequirementFileRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).RequirementFile(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/oracle.v1.Query/RequirementFile",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).RequirementFile(ctx, req.(*QueryRequirementFileRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RequirementFile",
			Handler:    _Query_RequirementFile_Handler,
		},
		{
...
func (m *QueryCountsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.RequirementFileCount != 0 {
		i = encodeVarintQuery(dAtA, i, uint64(m.RequirementFileCount))
		i--
		dAtA[i] = 0x10
	}
...
func (m *QueryRequirementFileRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryRequirementFileRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryRequirementFileRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.RequirementFileId != 0 {
		i = encodeVarintQuery(dAtA, i, uint64(m.RequirementFileId))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *QueryRequirementFileResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryRequirementFileResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryRequirementFileResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.RequirementFile != nil {
		{
			size, err := m.RequirementFile.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *QueryCountsResponse) Size() (n int) {
	...
	if m.RequirementFileCount != 0 {
		n += 1 + sovQuery(uint64(m.RequirementFileCount))
	}
	if m.OracleScriptCount != 0 {
...
func (m *QueryRequirementFileRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.RequirementFileId != 0 {
		n += 1 + sovQuery(uint64(m.RequirementFileId))
	}
	return n
}

func (m *QueryRequirementFileResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryCountsResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RequirementFileCount", wireType)
			}
			m.RequirementFileCount = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowQuery
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RequirementFileCount |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *QueryRequirementFileRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryRequirementFileRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryRequirementFileRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *QueryRequirementFileResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryRequirementFileResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryRequirementFileResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RequirementFile", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.RequirementFile == nil {
				m.RequirementFile = &RequirementFile{}
			}
			if err := m.RequirementFile.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
