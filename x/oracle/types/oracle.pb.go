...
type DataSource struct {
	...
	RequirementFileId     uint64                                   `protobuf:"varint,7,opt,name=requirement_file_id,json=requirementFileId,proto3" json:"requirement_file_id,omitempty"`
	Language              string                                   `protobuf:"bytes,8,opt,name=language,proto3" json:"language,omitempty"`
	UsedExternalLibraries string                                   `protobuf:"bytes,9,opt,name=used_external_libraries,json=usedExternalLibraries,proto3" json:"used_external_libraries,omitempty"`
}
...
func (m *DataSource) GetRequirementFileId() uint64 {
	if m != nil {
		return m.RequirementFileId
	}
	return 0
}

func (m *DataSource) GetLanguage() string {
	if m != nil {
		return m.Language
	}
	return ""
...
func (m *DataSource) GetUsedExternalLibraries() string {
	if m != nil {
		return m.UsedExternalLibraries
	}
	return ""
}

// RequirementFile is the data structure for storing data sources in the
// storage.
...
func (m *RequirementFile) Reset()         { *m = RequirementFile{} }
func (m *RequirementFile) String() string { return proto.CompactTextString(m) }
func (*RequirementFile) ProtoMessage()    {}
func (*RequirementFile) Descriptor() ([]byte, []int) {
	return fileDescriptor_652b57db11528d07, []int{1}
}
func (m *RequirementFile) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RequirementFile) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RequirementFile.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RequirementFile) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequirementFile.Merge(m, src)
}
func (m *RequirementFile) XXX_Size() int {
	return m.Size()
}
func (m *RequirementFile) XXX_DiscardUnknown() {
	xxx_messageInfo_RequirementFile.DiscardUnknown(m)
}

var xxx_messageInfo_RequirementFile proto.InternalMessageInfo

func (m *RequirementFile) GetOwner() string {
	if m != nil {
		return m.Owner
	}
	return ""
...
func (m *RequirementFile) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *RequirementFile) GetDescription() string {
	if m != nil {
		return m.Description
	}
	return ""
...
func (m *RequirementFile) GetFilename() string {
	if m != nil {
		return m.Filename
	}
	return ""
...
func (m *RequirementFile) GetTreasury() string {
	if m != nil {
		return m.Treasury
	}
	return ""
...
func (m *RequirementFile) GetFee() github_com_cosmos_cosmos_sdk_types.Coins {
	if m != nil {
		return m.Fee
	}
	return nil
...
type RawReport struct {
	...
	OffchainFeeUsed  github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,4,rep,name=offchain_fee_used,json=offchainFeeUsed,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.Coins" json:"offchain_fee_used"`
	InstallationTime string                                   `protobuf:"bytes,5,opt,name=installation_time,json=installationTime,proto3" json:"installation_time,omitempty"`
...
func (m *RawReport) GetOffchainFeeUsed() github_com_cosmos_cosmos_sdk_types.Coins {
	if m != nil {
		return m.OffchainFeeUsed
	}
	return nil
}

func (m *RawReport) GetInstallationTime() string {
	if m != nil {
		return m.InstallationTime
	}
	return ""
}

func (m *RawReport) GetExecutionTime() string {
	if m != nil {
...
type Request struct {
	...
	OffchainFeeLimit github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,11,rep,name=offchain_fee_limit,json=offchainFeeLimit,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.Coins" json:"offchain_fee_limit"`
}
...
func (m *Request) GetOffchainFeeLimit() github_com_cosmos_cosmos_sdk_types.Coins {
	if m != nil {
		return m.OffchainFeeLimit
	}
	return nil
}
...
func (m *Report) GetOffchainFeeUsed() github_com_cosmos_cosmos_sdk_types.Coins {
	if m != nil {
		return m.OffchainFeeUsed
	}
	return nil
...
type OracleRequestPacketData struct {
	...
	OffchainFeeLimit github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,9,rep,name=offchain_fee_limit,json=offchainFeeLimit,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.Coins" json:"offchain_fee_limit"`
}
...
func (m *OracleRequestPacketData) GetOffchainFeeLimit() github_com_cosmos_cosmos_sdk_types.Coins {
	if m != nil {
		return m.OffchainFeeLimit
	}
	return nil
...
type Params struct {
	...
	BaseOffchainFeePerHour uint64 `protobuf:"varint,12,opt,name=base_offchain_fee_per_hour,json=baseOffchainFeePerHour,proto3" json:"base_offchain_fee_per_hour,omitempty"`
}
...
func (m *Params) GetBaseOffchainFeePerHour() uint64 {
	if m != nil {
		return m.BaseOffchainFeePerHour
	}
	return 0
}
...
func init() {
	...
	proto.RegisterType((*RequirementFile)(nil), "oracle.v1.RequirementFile")
...
var fileDescriptor_652b57db11528d07 = []byte{
	...
	,
}
...
func (this *DataSource) Equal(that interface{}) bool {
	...
	if this.RequirementFileId != that1.RequirementFileId {
		return false
	}
	if this.Language != that1.Language {
		return false
	}
	if this.UsedExternalLibraries != that1.UsedExternalLibraries {
		return false
	}
	return true
}
func (this *RequirementFile) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*RequirementFile)
	if !ok {
		that2, ok := that.(RequirementFile)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *RawReport) Equal(that interface{}) bool {
	...
	if len(this.OffchainFeeUsed) != len(that1.OffchainFeeUsed) {
		return false
	}
	for i := range this.OffchainFeeUsed {
		if !this.OffchainFeeUsed[i].Equal(&that1.OffchainFeeUsed[i]) {
			return false
		}
	}
	if this.InstallationTime != that1.InstallationTime {
		return false
	}
...
func (this *Request) Equal(that interface{}) bool {
	...
	if len(this.OffchainFeeLimit) != len(that1.OffchainFeeLimit) {
		return false
	}
	for i := range this.OffchainFeeLimit {
		if !this.OffchainFeeLimit[i].Equal(&that1.OffchainFeeLimit[i]) {
			return false
		}
	}
	return true
...
func (this *Params) Equal(that interface{}) bool {
	...
	if this.BaseOffchainFeePerHour != that1.BaseOffchainFeePerHour {
		return false
	}
	return true
}
...
func (m *DataSource) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.UsedExternalLibraries) > 0 {
		i -= len(m.UsedExternalLibraries)
		copy(dAtA[i:], m.UsedExternalLibraries)
		i = encodeVarintOracle(dAtA, i, uint64(len(m.UsedExternalLibraries)))
		i--
		dAtA[i] = 0x4a
	}
	if len(m.Language) > 0 {
		...
		i = encodeVarintOracle(dAtA, i, uint64(len(m.Language)))
		i--
		dAtA[i] = 0x42
	}
	if m.RequirementFileId != 0 {
		i = encodeVarintOracle(dAtA, i, uint64(m.RequirementFileId))
		i--
		dAtA[i] = 0x38
	}
	if len(m.Fee) > 0 {
...
func (m *RequirementFile) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RequirementFile) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RequirementFile) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *RawReport) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ExecutionTime) > 0 {
		...
		i = encodeVarintOracle(dAtA, i, uint64(len(m.ExecutionTime)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.InstallationTime) > 0 {
		i -= len(m.InstallationTime)
		copy(dAtA[i:], m.InstallationTime)
		i = encodeVarintOracle(dAtA, i, uint64(len(m.InstallationTime)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.OffchainFeeUsed) > 0 {
		for iNdEx := len(m.OffchainFeeUsed) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.OffchainFeeUsed[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *Request) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.OffchainFeeLimit) > 0 {
		for iNdEx := len(m.OffchainFeeLimit) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.OffchainFeeLimit[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.BaseOffchainFeePerHour != 0 {
		i = encodeVarintOracle(dAtA, i, uint64(m.BaseOffchainFeePerHour))
		i--
		dAtA[i] = 0x60
	}
...
func (m *DataSource) Size() (n int) {
	...
	if m.RequirementFileId != 0 {
		n += 1 + sovOracle(uint64(m.RequirementFileId))
	}
	l = len(m.Language)
	if l > 0 {
		n += 1 + l + sovOracle(uint64(l))
	}
	l = len(m.UsedExternalLibraries)
	if l > 0 {
		n += 1 + l + sovOracle(uint64(l))
	}
	return n
...
func (m *RequirementFile) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RawReport) Size() (n int) {
	...
	if len(m.OffchainFeeUsed) > 0 {
		for _, e := range m.OffchainFeeUsed {
			l = e.Size()
			n += 1 + l + sovOracle(uint64(l))
		}
	}
	l = len(m.InstallationTime)
	if l > 0 {
		n += 1 + l + sovOracle(uint64(l))
	}
...
func (m *Request) Size() (n int) {
	...
	if len(m.OffchainFeeLimit) > 0 {
		for _, e := range m.OffchainFeeLimit {
			l = e.Size()
			n += 1 + l + sovOracle(uint64(l))
		}
	}
...
func (m *Params) Size() (n int) {
	...
	if m.BaseOffchainFeePerHour != 0 {
		n += 1 + sovOracle(uint64(m.BaseOffchainFeePerHour))
	}
	return n
}
...
func (m *DataSource) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RequirementFileId", wireType)
			}
			m.RequirementFileId = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowOracle
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RequirementFileId |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UsedExternalLibraries", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.UsedExternalLibraries = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *RequirementFile) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RequirementFile: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RequirementFile: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RawReport) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OffchainFeeUsed", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OffchainFeeUsed = append(m.OffchainFeeUsed, types.Coin{})
			if err := m.OffchainFeeUsed[len(m.OffchainFeeUsed)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InstallationTime", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.InstallationTime = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
...
func (m *Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OffchainFeeLimit", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OffchainFeeLimit = append(m.OffchainFeeLimit, types.Coin{})
			if err := m.OffchainFeeLimit[len(m.OffchainFeeLimit)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field BaseOffchainFeePerHour", wireType)
			}
			m.BaseOffchainFeePerHour = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowOracle
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.BaseOffchainFeePerHour |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
