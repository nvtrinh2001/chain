...
func (*MsgLockRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_fca3e5423dfcc220, []int{0}
}
...
func (*MsgLockResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_fca3e5423dfcc220, []int{1}
}
...
type MsgClaimRequest struct {
	...
	GuardedFeeID GuardedFeeID `protobuf:"varint,2,opt,name=guarded_fee_id,json=guardedFeeId,proto3,casttype=GuardedFeeID" json:"guarded_fee_id,omitempty"`
}
...
func (*MsgClaimRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_fca3e5423dfcc220, []int{2}
}
...
func (m *MsgClaimRequest) GetGuardedFeeID() GuardedFeeID {
	if m != nil {
...
func (*MsgClaimResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_fca3e5423dfcc220, []int{3}
}
...
func init() { proto.RegisterFile("guardian/v1/tx.proto", fileDescriptor_fca3e5423dfcc220) }

var fileDescriptor_fca3e5423dfcc220 = []byte{
	// 413 bytes of a gzipped FileDescriptorProto
	,
}
...
func (this *MsgClaimRequest) Equal(that interface{}) bool {
	...
	if this.GuardedFeeID != that1.GuardedFeeID {
		return false
	}
	return true
}
...
func (m *MsgClaimRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.GuardedFeeID != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.GuardedFeeID))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Payee) > 0 {
...
func (m *MsgClaimRequest) Size() (n int) {
	...
	if m.GuardedFeeID != 0 {
		n += 1 + sovTx(uint64(m.GuardedFeeID))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.GuardedFeeID |= GuardedFeeID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
