...
// source: feelocker/v1/feelocker.proto
...
func (STATUS) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_81f7825ae5493941, []int{0}
}
...
func (*LockedFee) Descriptor() ([]byte, []int) {
	return fileDescriptor_81f7825ae5493941, []int{1}
}
...
func (m *LockedFee) GetPayer() string {
	if m != nil {
		return m.Payer
	}
	return ""
...
func (m *LockedFee) GetPayees() []*Payee {
	if m != nil {
		return m.Payees
	}
	return nil
...
func (m *LockedFee) GetFee() github_com_cosmos_cosmos_sdk_types.Coins {
	if m != nil {
		return m.Fee
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*LockedFee)(nil), "guardian.v1.LockedFee")
}

func init() { proto.RegisterFile("feelocker/v1/feelocker.proto", fileDescriptor_81f7825ae5493941) }

var fileDescriptor_81f7825ae5493941 = []byte{
	// 360 bytes of a gzipped FileDescriptorProto
	,
}
...
func (this *LockedFee) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*LockedFee)
	if !ok {
		that2, ok := that.(LockedFee)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *Payee) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Status != 0 {
		i = encodeVarintFeelocker(dAtA, i, uint64(m.Status))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Payee) > 0 {
		i -= len(m.Payee)
		copy(dAtA[i:], m.Payee)
		i = encodeVarintFeelocker(dAtA, i, uint64(len(m.Payee)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *LockedFee) MarshalToSizedBuffer(dAtA []byte) (int, error) {
		...
		for iNdEx := len(m.Fee) - 1; iNdEx >= 0; iNdEx-- {
			{
				...
				i -= size
				i = encodeVarintFeelocker(dAtA, i, uint64(size))
			}
			i--
			dAtA[i] = 0x1a
		}
	...
	if len(m.Payer) > 0 {
		i -= len(m.Payer)
		copy(dAtA[i:], m.Payer)
		i = encodeVarintFeelocker(dAtA, i, uint64(len(m.Payer)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func encodeVarintFeelocker(dAtA []byte, offset int, v uint64) int {
	offset -= sovFeelocker(v)
	base := offset
	for v >= 1<<7 {
...
func (m *Payee) Size() (n int) {
	...
	l = len(m.Payee)
	if l > 0 {
		n += 1 + l + sovFeelocker(uint64(l))
	}
	if m.Status != 0 {
		n += 1 + sovFeelocker(uint64(m.Status))
	}
	return n
}
...
func sovFeelocker(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozFeelocker(x uint64) (n int) {
	return sovFeelocker(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *Payee) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return ErrIntOverflowFeelocker
			}
			if iNdEx >= l {
		...
		case 1:
			...
			if intStringLen < 0 {
				return ErrInvalidLengthFeelocker
			}
		...
		default:
			iNdEx = preIndex
			skippy, err := skipFeelocker(dAtA[iNdEx:])
			if err != nil {
				return err
			}
...
func skipFeelocker(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowFeelocker
			}
			if iNdEx >= l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthFeelocker
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupFeelocker
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthFeelocker        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowFeelocker          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupFeelocker = fmt.Errorf("proto: unexpected end of group")
)
